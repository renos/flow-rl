...
from craftax.craftax.envs.craftax_symbolic_env import (
    CraftaxSymbolicEnv as CraftaxEnv,
)
import numpy as np
from jax import jit
...
env = AutoResetEnvWrapper(CraftaxEnv())
...
def verify_function(functions):
    ...
    exec("from craftax.craftax.constants import *", namespace)
    exec("from craftax.craftax.craftax_state import  Inventory", namespace)
