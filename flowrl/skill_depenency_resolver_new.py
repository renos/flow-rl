...
class SkillDependencyResolver:
    ...
    def resolve_dependencies(self, target_skill_name, n=1, initial_state=None):
        """
        ...
        if SYMBOLIC_STATE_AVAILABLE:
            self.symbolic_operators = self._build_symbolic_operators(processed_skills)
    ...
    def _build_symbolic_operators(self, processed_skills: Dict) -> Dict:
