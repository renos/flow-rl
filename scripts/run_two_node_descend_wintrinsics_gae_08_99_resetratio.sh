#!/bin/bash
# Run PPO Flow on a single-node experiment with GAE=0.8 and latest reset rebase disabled

set -euo pipefail

echo "========================================"
echo "Run: Two-Node Descend (wintrinsics, GAE=0.8, no-rebase)"
echo "========================================"
...
WANDB_PROJECT=${WANDB_PROJECT:-flow_rl_two_node_descend_wintr}
