#!/bin/bash
# Run PPO Flow with TransformerXL on the premade Craftax baseline on GPU 5

set -euo pipefail

echo "========================================"
echo "Run: Premade Craftax PPO TransformerXL (GPU 5)"
echo "========================================"
...
WANDB_PROJECT=${WANDB_PROJECT:-flow_rl_premade_craftax_txrl}
