#!/bin/bash
# Run PPO Flow on the premade Craftax baseline with per-skill advantage normalization enabled

set -euo pipefail

echo "========================================"
echo "Run: Premade Craftax PPO Baseline (Per-Skill Adv Norm)"
echo "========================================"
...
# Per-skill advantage normalization
PER_SKILL_ADV_NORM=${PER_SKILL_ADV_NORM:-true}
PER_SKILL_ADV_MIN_COUNT=${PER_SKILL_ADV_MIN_COUNT:-32}
...
echo "  GPU_ID:                       $GPU_ID"
echo "  PER_SKILL_ADV_NORM:           $PER_SKILL_ADV_NORM"
echo "  PER_SKILL_ADV_MIN_COUNT:      $PER_SKILL_ADV_MIN_COUNT"
echo
...
python -m flowrl.ppo_flow \
  ...
  $( [ "$PER_SKILL_ADV_NORM" = "true" ] && echo "--per_skill_adv_norm" ) \
  --per_skill_adv_min_count "$PER_SKILL_ADV_MIN_COUNT"
