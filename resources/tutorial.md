...
You can then use the wooden pickaxe to mine stone and craft stone tools, as well as reaching the ladder if blocked by stone.
...
Now the player should find the first ladder down to the dungeon, breaking any blocks in the way. Make sure to collect lots of wood from the overworld as it is rarer in the dungeons.
...
The first chest opened will contain a bow.  Arrows can be crafted at a crafting table using wood and stone. This bow in conjunction with a sword is critical to killing monsters.
